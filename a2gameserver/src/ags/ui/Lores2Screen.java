...
import ags.ui.graphics.GR2Image;
 ...
 * @author blurry
 */
public class Lores2Screen extends IVirtualScreen {
    public static BufferedImage screen = new BufferedImage(40, 48, BufferedImage.TYPE_INT_RGB);
    private GR2Image appleScreen = new GR2Image();
   ...
   /**
    ...
    public byte[] getBuffer() {
        try {
            ...
            changed = false;
            if (!stale || lastBuffer == null) {
                lastBuffer = appleScreen.getAppleImage();
            }
            return lastBuffer;
        } catch (IOException ex) {
            Logger.getLogger(Lores2Screen.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
